      ...
      o = {
              ...
              return (
                o.some(function (t) {
                  ...
                  ("function" == typeof ErrorEvent
                    ? (t = new ErrorEvent("error", { message: i }))
                ...
                })(e, [
                  {
                    ...
                    value: function (t) {
                      ...
                      return new Promise(function (c, u) {
                        (n = i.bind(null, t, { resolve: c, reject: u })),
              ...
              ? !!(function (t, e, r) {
                  if (
                    ...
                    if (
                      ...
                      var n = { x: y(t, e, "width"), y: y(t, e, "height") };
                  ...
                  if (
                    ...
                    var i = { x: y(t, e, "width"), y: y(t, e, "height") };
                    return (
              ...
              r = {
                dimensions: (function () {
                  ...
                  return r && (r = r.split("x")) && 2 === r.length
                    ? { width: parseInt(r[0], 10), height: parseInt(r[1], 10) }
                  ...
                  if (!y) {
                    ...
                    try {
                      for (e.s(); !(t = e.n()).done; ) {
                        var r = t.value;
                        c(r) ||
                          (v.push({ element: r, originalTabIndex: r.tabIndex }),
                          (r.tabIndex = -1));
                      }
                    } catch (t) {
                      e.e(t);
              ...
              !(function (t, e) {
                if ("function" == typeof t) {
                  ...
                  void 0 !== n && n !== r && h(t),
                    ...
                    o
                      ? o.add(t)
                      : a.set(r, new i({ waitTime: r, callback: t }));
                }
              })(
                t,
                arguments.length > 1 && void 0 !== arguments[1]
        ...
        68444: function (t, e) {
          ...
          function i() {
            window.Y.Global.on("tweak:change", function (t) {
              var e = t.getName(),
                r = { name: e, value: (t.config && t.config.value) || t.value };
              n[e] &&
              ...
              return (
                ...
                r.flatMap(function (t) {
                  return t
                    ...
                    .split(",")
                    .map(function (e) {
                      return { controllerName: e.trim(), controllerNode: t };
                    });
                })
              );
            },
                  ...
                  value: function () {
                    ...
                    return Array.from(this.controllerDataArrByNode.values())
                      ...
                      .flatMap(function (e) {
                        var r;
                        return null !==
                          (r = t._requestRteConfigs({ controllerData: e })) &&
                          void 0 !== r
                          ? r
                          : [];
                      });
                  ...
                  value: function (t) {
                    ...
                    this.controllerDataArrByNode.get(t).forEach(function (r) {
                      (function (t, e) {
                        ...
                        e._triggerSectionDestroy({ controllerData: r }),
                        r.destroy();
                    });
                  },
                },
          ...
          var X = (function (t) {
            function e(t) {
              ...
              !(function (t, e) {
                ...
                V(r, "dispatchHeaderHeightChangeEvent", function () {
                  ...
                  window.dispatchEvent(
                    new CustomEvent(I.cx, { detail: { headerHeight: t } })
                  );
                }),
                ...
                V(r, "openMenuOverlay", function () {
                  r.state.isOpen ||
                    (r.setState({ isOpen: !0, isVisible: !0, isSwitching: !0 }),
                    r.node
                      .closest("body")
                    ...
                    r.setState({ isSwitching: !1 }));
                }),
                V(r, "closeMenuOverlay", function () {
                  r.state.isOpen &&
                    (r.setState({ isOpen: !1, isVisible: !1, isSwitching: !1 }),
                    r.node
                      .closest("body")
                ...
                V(r, "updateNeighborSections", function () {
                  ...
                  o &&
                    ...
                    window.Y &&
                      window.Y.Global &&
                      window.Y.Global.fire("headerHeight", { headerHeight: i }),
              ...
              (r.ref = {
                ...
                r.updateHeaderShrinkState(),
                (r.pos = { distance: 0, then: 0 }),
                r.createBurgers(),
                r.determineBurgerVisibility(),
                (r.menu = new A({ node: r.ref.menu, header: r })),
                (r.scrollTop = window.scrollY),
                (r.onScroll = s(r.onScroll, 100)),
                r.setBurgerDisplay(),
                (r.globalEvents = [
                  { event: "frame:device:change", handler: r.closeMenuOverlay },
                  {
        ...
        63285: function (t, e, r) {
          ...
          var n = { sm: 576, md: 768, lg: 992, xl: 1100, xxl: 1200 },
            ...
            d = { Richtext: "richtext", Plaintext: "plaintext" };
        },
        22166: function (t) {
          t.exports = [
            "white",
          ...
          u.loadLazy = function (t) {
            var e =
              arguments.length > 1 && void 0 !== arguments[1]
                ? arguments[1]
                : {};
            return s.call(u, t, a({ allowSaveData: !0 }, e));
          };
          var l = u.loadAllLazy;
            ...
            var t =
              ...
              e =
                arguments.length > 1 && void 0 !== arguments[1]
                  ? arguments[1]
                  : void 0;
            return l.call(u, a({ allowSaveData: !0 }, t), e);
          }),
            (e.A = u);
        },
            ...
            ut = function () {
              ...
              return (
                ...
                (!e.length && !r.length) || m === P
                  ...
                  : ((h = e),
                    (d = r),
                    Promise.resolve({ directTargets: e, segmentables: r }))
              );
            },
            st = function (t) {
              var e,
              ...
              !(function (t, e) {
                ...
                a(this, "bind", function () {
                  ...
                  r.viewportWatcher.addNodes({
                    ...
                    callbacks: { onEnter: r.enteredViewport },
                  });
                }),
        ...
        9780: function (t, e, r) {
          t.exports = { default: r(26484), __esModule: !0 };
        },
        4123: function (t, e, r) {
          t.exports = { default: r(80251), __esModule: !0 };
        },
        3053: function (t, e, r) {
          t.exports = { default: r(67981), __esModule: !0 };
        },
        89829: function (t, e, r) {
          t.exports = { default: r(2981), __esModule: !0 };
        },
        10508: function (t, e, r) {
          t.exports = { default: r(68172), __esModule: !0 };
        },
        9506: function (t, e) {
          "use strict";
          (e.__esModule = !0),
        ...
        52500: function (t, e, r) {
          ...
          t.exports = function (t, e, r, y, g, m, b) {
            ...
            if (
              ...
              if (
                ((w = { values: L ? j : E(p), keys: m ? j : E(d), entries: A }),
                b)
              )
        ...
        82919: function (t, e, r) {
          var n = r(19786);
          n(n.S + n.F * !r(75872), "Object", { defineProperty: r(21672).f });
        },
        5310: function (t, e, r) {
          var n = r(64873),
            o = r(64796);
